...
import com.infamous.pirates_and_cowboys.entity.MobBoatEntity;
...
@OnlyIn(Dist.CLIENT)
public class MobBoatRenderer extends EntityRenderer<MobBoatEntity> {
   ...
   protected final MobBoatModel model = new MobBoatModel();

   public MobBoatRenderer(EntityRendererManager p_i46190_1_) {
      super(p_i46190_1_);
      this.shadowRadius = 0.8F;
   }

   public void render(MobBoatEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
   ...
   public ResourceLocation getTextureLocation(MobBoatEntity p_110775_1_) {
